  ...
  return (
    <>
      <Button
        ...
        className="fixed bottom-20 right-4 md:bottom-8 md:right-8 rounded-full h-14 w-14 shadow-md bg-gradient-primary hover:bg-primary-light flex items-center justify-center animate-pulse-soft button-hover"
      >
        {isOpen ? (
          <X className="h-6 w-6" />
        ) : (
      ...
      {isOpen && (
        <div className="fixed bottom-[5.5rem] md:bottom-28 right-4 md:right-8 w-80 h-96 glass border border-primary/20 p-4 animate-fade-in rounded-2xl">
