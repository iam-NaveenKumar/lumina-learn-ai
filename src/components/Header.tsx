      ...
      <div className="flex flex-col gap-1">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            <h2 className="text-2xl font-semibold text-primary font-['PT_Sans']">Hello, {username}</h2>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <Button 
              variant="outline" 
              className="flex items-center gap-2 rounded-full border-primary/20 hover:border-primary/80 text-primary header-button"
            >
        ...
        <p className="text-primary/80 ml-1 font-['PT_Sans']">How was your day? Shall we start learning?</p>
      </div>
    </header>
  );
};
